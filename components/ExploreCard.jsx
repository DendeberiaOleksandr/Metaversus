...
const ExploreCard = ({key, index, id, imgUrl, title, active, handleClick}) => (
    <motion.div
    ...
    >
        ...
        />
        {active !== id ? (
            <h3 className={"font-semibold sm:text-[26px] text-[18ox] text-white absolute z-0 lg:bottom-20 lg:rotate-[-90deg] lg:origin-[0,0]"}>
                {title}
            </h3>
        ) : (
